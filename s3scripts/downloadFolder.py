...
LOCAL = 'testDownloadDest' # local destination for download
...
def download_files(prefix, local, bucket, client):
    ...
    # and creates a directory for it if it doesnt exist.
    for d in dirs:
...
if __name__ == "__main__":
    try:
        ...
        PREFIX = ''
        download_files(PREFIX, LOCAL, BUCKET_NAME, s3)
        print("The contents of '%s' have been successfully downloaded into '%s'" % (BUCKET_NAME, LOCAL))
